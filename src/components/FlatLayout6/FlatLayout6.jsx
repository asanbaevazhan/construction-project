...
function FlatLayout6() {
  ...
  return (
    <div className="flat-links">
        ...
        >
        <Link to="/floor-six/flat-one" className='floor-one-flat-one'>
                <img src={flatOne} alt="" />
                <SearchOutlined 
        ...
        >
            <Link to="/floor-six/flat-two" className='floor-one-flat-two'>
                <img src={flatTwo} alt="" />
                <SearchOutlined 
                    style={{ fontSize: '30px', color: '#756b60'}}
                />
        ...
        >
             <Link to="/floor-six/flat-three" className='floor-one-flat-three'>
        ...
        >   
            <Link to="/floor-six/flat-four" className='floor-one-flat-four'>
        ...
        >   
            ...
            <Link to="/floor-six/flat-five" className='floor-one-flat-five'>
        ...
        >   
            ...
            <Link to="/floor-six/flat-six" className='floor-one-flat-six'>
              <img src={flatSix} alt="" />
              <SearchOutlined 
                    style={{ fontSize: '30px', color: '#756b60'}}
                  />
        ...
        >   
            <Link to="/floor-six/flat-seven" className='floor-one-flat-seven'>
        ...
        >   
            ...
            <Link to="/floor-six/flat-eight" className='floor-one-flat-eight'>
        ...
        >   
            ...
            <Link to="/floor-six/flat-nine" className='floor-one-flat-nine'>
        ...
        >   
            ...
            <Link to="/floor-six/flat-ten" className='floor-one-flat-ten'>
              <img src={flatTen} alt="" />
              <SearchOutlined 
                    style={{ fontSize: '30px', color: '#756b60'}}
              />
        ...
        >   
            ...
            <Link to="/floor-six/flat-eleven" className='floor-one-flat-eleven'>
        ...
        >   
            ...
            <Link to="/floor-six/flat-twelve" className='floor-one-flat-twelve'>
        ...
        >   
              ...
              <Link to="/floor-six/flat-thirteen" className='floor-one-flat-thirteen'>
