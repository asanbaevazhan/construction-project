...
function FlatLayout4() {
  ...
  return (
    <div className="flat-links">
        ...
        >
        <Link to="/floor-four/flat-one" className='floor-one-flat-one'>
                <img src={flatOne} alt="" />
                <SearchOutlined 
                    className="search"
        ...
        >
            <Link to="/floor-four/flat-two" className='floor-one-flat-two'>
                <img src={flatTwo} alt="" />
                <SearchOutlined 
                    className="search"
                    style={{ fontSize: '30px', color: '#756b60'}}
        ...
        >
             <Link to="/floor-four/flat-three" className='floor-one-flat-three'>
        ...
        >   
            <Link to="/floor-four/flat-four" className='floor-one-flat-four'>
        ...
        >   
            ...
            <Link to="/floor-four/flat-five" className='floor-one-flat-five'>
        ...
        >   
            ...
            <Link to="/floor-four/flat-six" className='floor-one-flat-six'>
              <img src={flatSix} alt="" />
              <SearchOutlined 
                    className="search"
                    style={{ fontSize: '30px', color: '#756b60'}}
        ...
        >   
            <Link to="/floor-four/flat-seven" className='floor-one-flat-seven'>
        ...
        >   
            ...
            <Link to="/floor-four/flat-eight" className='floor-one-flat-eight'>
        ...
        >   
            ...
            <Link to="/floor-four/flat-nine" className='floor-one-flat-nine'>
        ...
        >   
            ...
            <Link to="/floor-four/flat-ten" className='floor-one-flat-ten'>
              <img src={flatTen} alt="" />
              <SearchOutlined 
                    className="search"
                    style={{ fontSize: '30px', color: '#756b60'}}
        ...
        >   
            ...
            <Link to="/floor-four/flat-eleven" className='floor-one-flat-eleven'>
        ...
        >   
            ...
            <Link to="/floor-four/flat-twelve" className='floor-one-flat-twelve'>
        ...
        >   
              ...
              <Link to="/floor-four/flat-thirteen" className='floor-one-flat-thirteen'>
