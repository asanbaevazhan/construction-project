...
function FlatLayout7() {
  ...
  return (
    <div className="flat-links">
        ...
        >
        <Link to="/floor-seven/flat-one" className='floor-one-flat-one'>
                <img src={flatOne} alt="" />
                <SearchOutlined 
        ...
        >
            <Link to="/floor-seven/flat-two" className='floor-one-flat-two'>
                <img src={flatTwo} alt="" />
                <SearchOutlined 
                    style={{ fontSize: '30px', color: '#756b60'}}
                />
        ...
        >
             <Link to="/floor-seven/flat-three" className='floor-one-flat-three'>
        ...
        >   
            <Link to="/floor-seven/flat-four" className='floor-one-flat-four'>
        ...
        >   
            ...
            <Link to="/floor-seven/flat-five" className='floor-one-flat-five'>
        ...
        >   
            ...
            <Link to="/floor-seven/flat-six" className='floor-one-flat-six'>
              <img src={flatSix} alt="" />
              <SearchOutlined 
                    style={{ fontSize: '30px', color: '#756b60'}}
                  />
        ...
        >   
            <Link to="/floor-seven/flat-seven" className='floor-one-flat-seven'>
        ...
        >   
            ...
            <Link to="/floor-seven/flat-eight" className='floor-one-flat-eight'>
        ...
        >   
            ...
            <Link to="/floor-seven/flat-nine" className='floor-one-flat-nine'>
        ...
        >   
            ...
            <Link to="/floor-seven/flat-ten" className='floor-one-flat-ten'>
              <img src={flatTen} alt="" />
              <SearchOutlined 
                    style={{ fontSize: '30px', color: '#756b60'}}
              />
        ...
        >   
            ...
            <Link to="/floor-seven/flat-eleven" className='floor-one-flat-eleven'>
        ...
        >   
            ...
            <Link to="/floor-seven/flat-twelve" className='floor-one-flat-twelve'>
        ...
        >   
              ...
              <Link to="/floor-seven/flat-thirteen" className='floor-one-flat-thirteen'>
